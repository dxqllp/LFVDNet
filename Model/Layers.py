...
import sys
import torch
from Model.SubLayers import  PositionwiseFeedForward, MultiHeadAttention_tem_bias, MultiHeadAttention_type_bias
from einops import rearrange, repeat

PAD = 0

def get_attn_key_pad_mask_K(mask=None, transpose=False, full_attn=False):
